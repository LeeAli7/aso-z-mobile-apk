...
Устройство ──(напрямую)──► внешние провайдеры
                ...
                │
                └── URL провайдеров ЗАШИФРОВАНЫ в assets/secret.json
...
- `tools/build-secret.js` — генератор зашифрованного конфига (URL провайдеров, модели).
- `assets/secret.json` — результат (AES-CBC, crypto-js).
