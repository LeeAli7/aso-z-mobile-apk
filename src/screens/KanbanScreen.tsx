/**
 * KanbanScreen — доска агентов (заготовка, «скоро»).
 * План: kanban-доска Hermes — задачи субагентов по колонкам, статусы, назначение.
  ...
  return (
    <View style={{ flex: 1, backgroundColor: theme.bg }}>
      <View style={{ paddingTop: insets.top + 6, paddingHorizontal: 16, paddingBottom: 10, borderBottomWidth: 1, borderBottomColor: theme.border, flexDirection: "row", alignItems: "center" }}>
        ...
        <View>
          <Text style={{ color: theme.dim, fontSize: 11 }}>KANBAN</Text>
          <Text style={{ color: theme.text, fontSize: 22, fontWeight: "700", letterSpacing: -0.3 }}>Доска агентов</Text>
        </View>
      </View>
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: insets.bottom + 32 }}>
        <View style={{ padding: 14, borderRadius: 15, borderWidth: 1, borderColor: theme.border, backgroundColor: theme.surface }}>
          ...
          <Text style={{ color: theme.dim, fontSize: 12.5, lineHeight: 18 }}>
            Здесь будет kanban-доска Hermes: задачи субагентов по колонкам, статусы и назначение исполнителей.
          </Text>
        </View>
      </ScrollView>
    </View>
